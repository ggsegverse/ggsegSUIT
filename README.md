...
SUIT cerebellar atlas for the
[ggseg](https://github.com/ggseg/ggseg) plotting ecosystem.

Provides the SUIT anatomical parcellation of the cerebellum with 34 regions
covering lobules I-X, vermis subdivisions, and deep cerebellar nuclei
...
- `atl-Anatom_space-MNI_dseg.nii` -- discrete segmentation volume (MNI152, 1mm)
